...
Looking at the mean draft round for players that did not have surgery, and then comparing the draft round for players that had surgery before and after the draft. 
```{r}
pitchers_complete %>%
