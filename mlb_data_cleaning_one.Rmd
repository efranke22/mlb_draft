...
tommyjohn <- read_csv("data/tommyjohn.csv") %>%
  filter(Position == "P") %>%
...
Join with tommy john data. Create an indictor variable that indicates if the player has had tommy john surgery. 
```{r}
pitchers_recent_draft %>%
